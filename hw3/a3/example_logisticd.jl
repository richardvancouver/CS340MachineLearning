...
# @printf("logRegL2, lambda is: %.3f\n", 1.0)
# model = logRegL2(X,y,1.0)



# @printf("logRegL1, lambda is: %.3f\n", 1.0)
# model = logRegL1(X,y,1.0)

@printf("logRegL0, lambda is: %.3f\n", 1.0)
model = logRegL0(X,y,1.0)
